    ...
    public partial class FormMain : Form
    {
        ...
        void comm_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            this.Invoke((EventHandler)(delegate
            {
                ...
                var protocol = dataAnalyse.Received(buf);
                if (protocol != null)
                    foreach (var obj in linePanel.Controls)
                    {
                        if (obj.GetType() == typeof(UserControl.LineControl))
                        {
                            var lineControl = (UserControl.LineControl)obj;
                            lineControl.received(protocol);
                        }
                    }
        ...
        public void button_addMonitor_Click(object sender, EventArgs e)
        {
            linePanel.Controls.Add(new UserControl.LineControl());
        }
    }
}
